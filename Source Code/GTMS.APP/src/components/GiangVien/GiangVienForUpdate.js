...
import { isValidEmail, isValidPhoneNumber, getValue, formatDateString } from '../../utils'
...
class GiangVienForUpdate extends Component {
    constructor (props) {
      super(props)
      this.state = {
          data: {},
    ...
    submit() {
        ...
        if (hoVaTen !== '' && gioiTinh !== '' && ngaySinh !== '' && email !=='' && soDienThoai !=='' && queQuan !=='' && diaChi !=='' && donViCongTac !=='' && isValidEmail(email) && isValidPhoneNumber(soDienThoai)) {
            const { id } = this.props.match.params
            const url = apiRoutes.giangVien.updateById + '/' + id
        ...
        return (
            <Fragment>
                <section className='breadcrumbs'>
                    ...
                    <span className='breadcrumb-separator'><i className='fas fa-chevron-right'></i></span>
                    <span className='breadcrumb-active'><Link to='#'>Cập nhật thông tin giảng viên</Link></span>
                </section>

                <section className='section'>
                    <header className='section__header'>
                        <div className='section__header-left'>
                            <h3 className='section__title'>Cập nhật thông tin giảng viên</h3>
                            <p className='section__subtitle'>Cập nhật thông tin chi tiết của giảng viên</p>
                        </div>
                    </header>
                        ...
                        <div className='section-body-main'>
                            <form autoComplete='off'>
                                <div className='form-group'>
                                    <label className='form-label'>Mã cán bộ</label>
...
export default connect(mapStateToProps, null)(GiangVienForUpdate)