...
class LopForView extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data: {}
        ...
        return (
            <Fragment>
                <section className='breadcrumbs'>
                    ...
                    <span className='breadcrumb'><Link to='/khoa-dao-tao'>Quản lý lớp</Link></span>
                    <span className='breadcrumb-separator'><i className='fas fa-chevron-right'></i></span>
                    <span className='breadcrumb-active'><Link to='#'>Xem thông tin lớp</Link></span>
                </section>

                <section className='section'>
                    <header className='section__header'>
                        <div className='section__header-left'>
                            <h3 className='section__title'>Xem thông tin lớp</h3>
                            <p className='section__subtitle'>Xem thông tin chi tiết của lớp</p>
                        </div>
                    </header>
                        ...
                        <div className='section-body-main'>
                            <form autoComplete='off'>
                                ...
                                <div className='form-group'>
                                    ...
                                    <input type='text' className='form-input-disabled' value={getValue(this.state.data.tenLop)} disabled />
                                </div>
                                ...
                                <div className='form-group'>
                                    ...
                                    <input className='form-input-disabled' type='text' value={getValue(this.state.data.khoa && this.state.data.khoa.tenKhoa)} disabled />
                                </div>

                                <div className='form-group'>
                                    <label className='form-label'>Hệ đào tạo</label>
                                    <input className='form-input-disabled' type='text' value={getValue(this.state.data.heDaoTao)} disabled />
                                </div>

                                <div className='form-group'>
                                    <label className='form-label'>Khóa đào tạo</label>
                                    <input className='form-input-disabled' type='text' value={getValue(this.state.data.khoaDaoTao && this.state.data.khoaDaoTao.tenKhoaDaoTao)} disabled />
                                </div>
...
export default connect(mapStateToProps, null)(LopForView)