...
import KhoaDaoTaoForPrint from './KhoaDaoTaoForPrint'
...
class KhoaDaoTaoForList extends Component {
    constructor (props) {
      super(props)
      this.state = {
          data: [],
      ...
      this.fileReader.onload = (e) => {
        try {
            ...
            const fieldToParseNumber = ['maKhoaDaoTao', 'trangThai']
            let data
    ...
    async createMultiple() {
        const url = apiRoutes.khoaDaoTao.createMultiple
    ...
    async onTemporarilyDelete(id) {
        try {
            const url = apiRoutes.khoaDaoTao.temporarilyDeleteById + '/' + id
    ...
    async onPermanentlyDelete(id) {
        try {
            const url = apiRoutes.khoaDaoTao.permanentlyDeleteById + '/' + id
    ...
    async onRestore(id) {
        try {
            const url = apiRoutes.khoaDaoTao.restoreById + '/' + id
            const data = { trangThai: 1 }
    ...
    changeConfirmationValue(e) {
        ...
        const acceptedValue = this.state.activeRecord.maKhoaDaoTao.toString()
    ...
    exportDocumentAsXlsx() {
        ...
        worksheet.getCell('A4').value = 'DANH SÁCH CÁC KHÓA ĐÀO TẠO HIỆN CÓ TRONG HỆ THỐNG'
        ...
        worksheet.getCell('C7').value = 'Tên khóa đào tạo'
        ...
        worksheet.getCell('G7').value = 'Tên viết tắt của khóa đào tạo'
        ...
        worksheet.getCell('K7').value = 'Thời gian bắt đầu'
        ...
        worksheet.getCell('N7').value = 'Thời gian kết thúc'
        ...
        this.state.dataToExportDocument.forEach((record, index) => {
            ...
            worksheet.mergeCells('C' + currentRowIndex + ':F' + currentRowIndex)
            worksheet.getCell('C' + currentRowIndex).value = record.tenKhoaDaoTao
            ...
            worksheet.mergeCells('G' + currentRowIndex + ':J' + currentRowIndex)
            worksheet.getCell('G' + currentRowIndex).value = record.tenKhoaDaoTao
            ...
            worksheet.getCell('K' + currentRowIndex).value = formatDateString(record.thoiGianBatDau, false)
            ...
            worksheet.getCell('N' + currentRowIndex).value = formatDateString(record.thoiGianKetThuc, false)
        ...
        return (
            <Fragment>
                <section className='breadcrumbs'>
                    ...
                    <span className='breadcrumb-active'><Link to='/khoa-dao-tao'>Quản lý khóa đào tạo</Link></span>
                </section>

                <section className='section'>
                    <header className='section__header'>
                        <div className='section__header-left'>
                            <h3 className='section__title'>Danh sách khóa đào tạo</h3>
                            <p className='section__subtitle'>Danh sách tất cả các khóa đào tạo hiện đang được quản lý</p>
                        </div>
                        ...
                        <div className='section-body-main'>
                            ...
                            <table className='table'>
                                <thead>
                                    <tr>
                                        <th></th>
                                        {/* <th onClick={ () => this.sortByColumn('MaKhoaDaoTao') }>{ this.isBeingSorted('MaKhoaDaoTao') && <i className='fas fa-sort sort-button'></i> } Mã khóa đào tạo</th> */}
                                        <th onClick={ () => this.sortByColumn('TenKhoaDaoTao') }>{ this.isBeingSorted('TenKhoaDaoTao') && <i className='fas fa-sort sort-button'></i> } Tên khóa đào tạo</th>
                                        <th onClick={ () => this.sortByColumn('ThoiGianBatDau') }>{ this.isBeingSorted('ThoiGianBatDau') && <i className='fas fa-sort sort-button'></i> } Thời gian bắt đầu</th>
                                        <th onClick={ () => this.sortByColumn('ThoiGianKetThuc') }>{ this.isBeingSorted('ThoiGianKetThuc') && <i className='fas fa-sort sort-button'></i> } Thời gian kết thúc</th>
                                            ...
                                            <tr key={ index }>
                                                <td className='table-dropdown-menu-wrapper'>
                                                    ...
                                                    <ul className='table-dropdown-menu'>
                                                        <li className='table-dropdown-menu-item'><Link to={ '/khoa-dao-tao/xem-thong-tin/' + record.maKhoaDaoTao }>Xem thông tin</Link></li>
                                                        <li className='table-dropdown-menu-item'><Link to={ '/khoa-dao-tao/cap-nhat/' + record.maKhoaDaoTao }>Cập nhật thông tin</Link></li>
                                                ...
                                                {/* <td className='table-text-bold'>{ record.maKhoaDaoTao }</td> */}
                                                <td>{ record.tenKhoaDaoTao }</td>
                                                <td>{ formatDateString(record.thoiGianBatDau, false) }</td>
                                                <td>{ formatDateString(record.thoiGianKetThuc, false) }</td>
                ...
                { this.state.showPopup.temporarilyDelete && <div className='popup-wrapper'>
                    <div className='popup'>
                        ...
                        <div className='popup__body'>
                            { !this.state.showPopupErrorMessage && <p>Bạn có chắc chắn muốn xóa tạm thời khóa đào tạo <strong>{ this.state.activeRecord.tenKhoaDaoTao }</strong> khỏi hệ thống hay không?</p> }
                        ...
                        <footer className='popup__footer'>
                            ...
                            { !this.state.showPopupErrorMessage && <span className='popup-button-danger' onClick={ () => this.onTemporarilyDelete(this.state.activeRecord.maKhoaDaoTao) }>Đồng ý</span> }
                        </footer>
                    </div>
                </div> }
                    ...
                    <div className='popup'>
                        ...
                        <div className='popup__body'>
                            { !this.state.showPopupErrorMessage && <Fragment>
                                <p className='alert-message'>Bạn có chắc chắn muốn xóa vĩnh viễn khóa đào tạo <strong>{ this.state.activeRecord.tenKhoaDaoTao }</strong> khỏi hệ thống hay không?</p>
                                <p>Hành động này đồng nghĩa với việc dữ liệu sẽ bị xóa vĩnh viễn khỏi hệ thống và không thể khôi phục lại được. Để xác nhận, vui lòng nhập <span className='pre'>{ this.state.activeRecord.maKhoaDaoTao }</span> vào khung bên dưới</p>
                        ...
                        <footer className='popup__footer'>
                            ...
                            { !this.state.showPopupErrorMessage && <Fragment>
                                { this.state.validConfirmationValue ? <span className='popup-button-danger' onClick={ () => this.onPermanentlyDelete(this.state.activeRecord.maKhoaDaoTao) }>Đồng ý</span> : <span className='popup-button-default'>Đồng ý</span> }
                            </Fragment> }
                        </footer>
                    </div>
                </div> }
                ...
                { this.state.showPopup.restore && <div className='popup-wrapper'>
                    <div className='popup'>
                        ...
                        <div className='popup__body'>
                            { !this.state.showPopupErrorMessage && <p>Bạn có chắc chắn muốn khôi phục lại khóa đào tạo <strong>{ this.state.activeRecord.tenKhoaDaoTao }</strong> đã bị xóa tạm thời hay không?</p> }
                        ...
                        <footer className='popup__footer'>
                            ...
                            { !this.state.showPopupErrorMessage && <span className='popup-button-danger' onClick={ () => this.onRestore(this.state.activeRecord.maKhoaDaoTao) }>Đồng ý</span> }
                        </footer>
                    </div>
                </div> }
                ...
                <KhoaDaoTaoForPrint data={ this.state.dataToExportDocument } />
            </Fragment>
        )
    }
}
...
export default connect(mapStateToProps, null)(KhoaDaoTaoForList)