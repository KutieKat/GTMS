...
class KhoaDaoTaoForPrint extends Component {
    constructor(props) {
        super(props)
        this.state = {
            settings: {}
            ...
            <div className='printing-page'>
                <div className='printing-page__header'>
                    ...
                    <div className='printing-page__main'>
                        <h1 className='printing-page-title'>DANH SÁCH CÁC KHÓA ĐÀO TẠO HIỆN CÓ TRONG HỆ THỐNG</h1>
                    ...
                    <table className='printing-page-table'>
                        <thead>
                            <tr>
                                ...
                                <th>Tên viết tắt của khóa đào tạo</th>
...
export default KhoaDaoTaoForPrint