...
class SinhVienForView extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data: {}
        ...
        return (
            <Fragment>
                <section className='breadcrumbs'>
                    ...
                    <span className='breadcrumb-separator'><i className='fas fa-chevron-right'></i></span>
                    <span className='breadcrumb-active'><Link to='#'>Xem thông tin sinh viên</Link></span>
                </section>

                <section className='section'>
                    <header className='section__header'>
                        <div className='section__header-left'>
                            <h3 className='section__title'>Xem thông tin sinh viên</h3>
                            <p className='section__subtitle'>Xem thông tin chi tiết của sinh viên</p>
                        </div>
                    </header>
                        ...
                        <div className='section-body-main'>
                            <form autoComplete='off'>
                                ...
                                <div className='form-group'>
                                    ...
                                    <input className='form-input-disabled' type='text' value={getValue(this.state.data.lop && this.state.data.lop.tenLop)} disabled />
                                </div>
...
export default connect(mapStateToProps, null)(SinhVienForView)