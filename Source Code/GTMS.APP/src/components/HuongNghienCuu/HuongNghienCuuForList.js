...
import HuongNghienCuuForPrint from './HuongNghienCuuForPrint'
...
class HuongNghienCuuForList extends Component {
    constructor (props) {
      super(props)
      this.state = {
          data: [],
      ...
      this.fileReader.onload = (e) => {
        try {
            ...
            const fieldToParseNumber = ['maHuongNghienCuu', 'trangThai']
            let data
    ...
    async createMultiple() {
        const url = apiRoutes.huongNghienCuu.createMultiple
    ...
    async onTemporarilyDelete(id) {
        try {
            const url = apiRoutes.huongNghienCuu.temporarilyDeleteById + '/' + id
    ...
    async onPermanentlyDelete(id) {
        try {
            const url = apiRoutes.huongNghienCuu.permanentlyDeleteById + '/' + id
    ...
    async onRestore(id) {
        try {
            const url = apiRoutes.huongNghienCuu.restoreById + '/' + id
            const data = { trangThai: 1 }
    ...
    changeConfirmationValue(e) {
        ...
        const acceptedValue = this.state.activeRecord.maHuongNghienCuu.toString()
    ...
    exportDocumentAsXlsx() {
        ...
        worksheet.getCell('A4').value = 'DANH SÁCH CÁC HƯỚNG NGHIÊN CỨU HIỆN CÓ TRONG HỆ THỐNG'
        ...
        worksheet.getCell('C7').value = 'Tên hướng nghiên cứu'
        ...
        this.state.dataToExportDocument.forEach((record, index) => {
            ...
            worksheet.mergeCells('C' + currentRowIndex + ':P' + currentRowIndex)
            worksheet.getCell('C' + currentRowIndex).value = record.tenHuongNghienCuu
        ...
        return (
            <Fragment>
                <section className='breadcrumbs'>
                    ...
                    <span className='breadcrumb-active'><Link to='/huong-nghien-cuu'>Quản lý hướng nghiên cứu</Link></span>
                </section>

                <section className='section'>
                    <header className='section__header'>
                        <div className='section__header-left'>
                            <h3 className='section__title'>Danh sách hướng nghiên cứu</h3>
                            <p className='section__subtitle'>Danh sách tất cả các hướng nghiên cứu hiện đang được quản lý</p>
                        </div>
                        ...
                        <div className='section__header-right'>
                            ...
                            <span className='button'>
                                <Link to='/huong-nghien-cuu/them-moi'>
                        ...
                        <div className='section-body-main'>
                            ...
                            <table className='table'>
                                <thead>
                                    <tr>
                                        <th></th>
                                        {/* <th onClick={ () => this.sortByColumn('MaHuongNghienCuu') }>{ this.isBeingSorted('MaHuongNghienCuu') && <i className='fas fa-sort sort-button'></i> } Mã hướng nghiên cứu</th> */}
                                        <th onClick={ () => this.sortByColumn('TenHuongNghienCuu') }>{ this.isBeingSorted('TenHuongNghienCuu') && <i className='fas fa-sort sort-button'></i> } Tên hướng nghiên cứu</th>
                                            ...
                                            <tr key={ index }>
                                                <td className='table-dropdown-menu-wrapper'>
                                                    ...
                                                    <ul className='table-dropdown-menu'>
                                                        <li className='table-dropdown-menu-item'><Link to={ '/huong-nghien-cuu/xem-thong-tin/' + record.maHuongNghienCuu }>Xem thông tin</Link></li>
                                                        <li className='table-dropdown-menu-item'><Link to={ '/huong-nghien-cuu/cap-nhat/' + record.maHuongNghienCuu }>Cập nhật thông tin</Link></li>
                                                ...
                                                {/* <td className='table-text-bold'>{ record.maHuongNghienCuu }</td> */}
                                                <td>{ record.tenHuongNghienCuu }</td>
                ...
                { this.state.showPopup.temporarilyDelete && <div className='popup-wrapper'>
                    <div className='popup'>
                        ...
                        <div className='popup__body'>
                            { !this.state.showPopupErrorMessage && <p>Bạn có chắc chắn muốn xóa tạm thời hướng nghiên cứu <strong>{ this.state.activeRecord.tenHuongNghienCuu }</strong> khỏi hệ thống hay không?</p> }
                        ...
                        <footer className='popup__footer'>
                            ...
                            { !this.state.showPopupErrorMessage && <span className='popup-button-danger' onClick={ () => this.onTemporarilyDelete(this.state.activeRecord.maHuongNghienCuu) }>Đồng ý</span> }
                        </footer>
                    </div>
                </div> }
                    ...
                    <div className='popup'>
                        ...
                        <div className='popup__body'>
                            { !this.state.showPopupErrorMessage && <Fragment>
                                <p className='alert-message'>Bạn có chắc chắn muốn xóa vĩnh viễn hướng nghiên cứu <strong>{ this.state.activeRecord.tenHuongNghienCuu }</strong> khỏi hệ thống hay không?</p>
                                <p>Hành động này đồng nghĩa với việc dữ liệu sẽ bị xóa vĩnh viễn khỏi hệ thống và không thể khôi phục lại được. Để xác nhận, vui lòng nhập <span className='pre'>{ this.state.activeRecord.maHuongNghienCuu }</span> vào khung bên dưới</p>
                        ...
                        <footer className='popup__footer'>
                            ...
                            { !this.state.showPopupErrorMessage && <Fragment>
                                { this.state.validConfirmationValue ? <span className='popup-button-danger' onClick={ () => this.onPermanentlyDelete(this.state.activeRecord.maHuongNghienCuu) }>Đồng ý</span> : <span className='popup-button-default'>Đồng ý</span> }
                            </Fragment> }
                        </footer>
                    </div>
                </div> }
                ...
                { this.state.showPopup.restore && <div className='popup-wrapper'>
                    <div className='popup'>
                        ...
                        <div className='popup__body'>
                            { !this.state.showPopupErrorMessage && <p>Bạn có chắc chắn muốn khôi phục lại hướng nghiên cứu <strong>{ this.state.activeRecord.tenHuongNghienCuu }</strong> đã bị xóa tạm thời hay không?</p> }
                        ...
                        <footer className='popup__footer'>
                            ...
                            { !this.state.showPopupErrorMessage && <span className='popup-button-danger' onClick={ () => this.onRestore(this.state.activeRecord.maHuongNghienCuu) }>Đồng ý</span> }
                        </footer>
                    </div>
                </div> }
                ...
                <HuongNghienCuuForPrint data={ this.state.dataToExportDocument } />
            </Fragment>
        )
    }
}
...
export default connect(mapStateToProps, null)(HuongNghienCuuForList)