...
class HuongNghienCuuForPrint extends Component {
    constructor(props) {
        super(props)
        this.state = {
            settings: {}
            ...
            <div className='printing-page'>
                <div className='printing-page__header'>
                    ...
                    <div className='printing-page__main'>
                        <h1 className='printing-page-title'>DANH SÁCH CÁC HƯỚNG NGHIÊN CỨU HIỆN CÓ TRONG HỆ THỐNG</h1>
...
export default HuongNghienCuuForPrint