...
import TaiKhoanForPrint from './TaiKhoanForPrint'
...
class HocKyForList extends Component {
    ...
    async fetchData() {
        const url = apiRoutes.taiKhoan.getAll
    ...
    exportDocumentAsXlsx() {
        ...
        worksheet.getCell('C7').value = 'Tên tài khoản'
        ...
        return (
            <Fragment>
                <section className='breadcrumbs'>
                    ...
                    <span className='breadcrumb-active'><Link to='/tai-khoan'>Quản lý tài khoản</Link></span>
                </section>

                <section className='section'>
                    <header className='section__header'>
                        <div className='section__header-left'>
                            <h3 className='section__title'>Danh sách tài khoản</h3>
                            <p className='section__subtitle'>Danh sách tất cả các tài khoản hiện đang được quản lý</p>
                        </div>
                        ...
                        <div className='section-body-main'>
                            ...
                            <table className='table'>
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th onClick={ () => this.sortByColumn('TenDangNhap') }>{ this.isBeingSorted('TenDangNhap') && <i className='fas fa-sort sort-button'></i> } Tên đăng nhập</th>
                                            ...
                                            <tr key={ index }>
                                                <td className='table-dropdown-menu-wrapper'>
                                                    ...
                                                    <ul className='table-dropdown-menu'>
                                                        <li className='table-dropdown-menu-item'><Link to={ '/tai-khoan/xem-thong-tin/' + record.maTaiKhoan }>Xem thông tin</Link></li>
                                                        <li className='table-dropdown-menu-item'><Link to={ '/tai-khoan/cap-nhat/' + record.maTaiKhoan }>Cập nhật thông tin</Link></li>
                                                ...
                                                <td>{ record.tenDangNhap }</td>
                                                <td>{ formatDateString(record.thoiGianTao, false) }</td>
                                                <td>{ formatDateString(record.thoiGianCapNhat, false) }</td>
                ...
                { this.state.showPopup.temporarilyDelete && <div className='popup-wrapper'>
                    <div className='popup'>
                        ...
                        <div className='popup__body'>
                            { !this.state.showPopupErrorMessage && <p>Bạn có chắc chắn muốn xóa tạm thời tài khoản <strong>{ this.state.activeRecord.tenHocKy }</strong> khỏi hệ thống hay không?</p> }
                    ...
                    <div className='popup'>
                        ...
                        <div className='popup__body'>
                            { !this.state.showPopupErrorMessage && <Fragment>
                                <p className='alert-message'>Bạn có chắc chắn muốn xóa vĩnh viễn tài khoản <strong>{ this.state.activeRecord.tenHocKy }</strong> khỏi hệ thống hay không?</p>
                ...
                { this.state.showPopup.restore && <div className='popup-wrapper'>
                    <div className='popup'>
                        ...
                        <div className='popup__body'>
                            { !this.state.showPopupErrorMessage && <p>Bạn có chắc chắn muốn khôi phục lại tài khoản <strong>{ this.state.activeRecord.tenHocKy }</strong> đã bị xóa tạm thời hay không?</p> }
                ...
                <TaiKhoanForPrint data={ this.state.dataToExportDocument } />
            </Fragment>
        )
    }
}
