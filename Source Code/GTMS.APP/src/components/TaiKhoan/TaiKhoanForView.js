...
class TaiKhoanForView extends Component {
    ...
    async fetchData() {
        ...
        const url = apiRoutes.taiKhoan.getById + '/' + id
        ...
        return (
            <Fragment>
                <section className='breadcrumbs'>
                    ...
                    <span className='breadcrumb'><Link to='/tai-khoan'>Quản lý tài khoản</Link></span>
                    <span className='breadcrumb-separator'><i className='fas fa-chevron-right'></i></span>
                    <span className='breadcrumb-active'><Link to='#'>Xem thông tin tài khoản</Link></span>
                </section>

                <section className='section'>
                    <header className='section__header'>
                        <div className='section__header-left'>
                            <h3 className='section__title'>Xem thông tin tài khoản</h3>
                            <p className='section__subtitle'>Xem thông tin chi tiết của tài khoản</p>
                        </div>
                    </header>
                        ...
                        <div className='section-body-main'>
                            <form autoComplete='off'>
                                <div className='form-group'>
                                    ...
                                    <input type='text' className='form-input-disabled' value={getValue(this.state.data.maTaiKhoan)} disabled />
                                </div>

                                <div className='form-group'>
                                    <label className='form-label'>Tên đăng nhập</label>
                                    <input type='text' className='form-input-disabled' value={getValue(this.state.data.tenDangNhap)} disabled />
                                </div>
...
export default connect(mapStateToProps, null)(TaiKhoanForView)