...
class KhoaForView extends Component {
    constructor (props) {
      super(props)
      this.state = {
          data: {}
        ...
        return (
            <Fragment>
                ...
                <span className='breadcrumb-home'><Link to='/'>Graduation Thesis Management System (GTMS)</Link></span>
                    ...
                    <span className='breadcrumb-separator'><i className='fas fa-chevron-right'></i></span>
                    <span className='breadcrumb-active'><Link to='#'>Xem thông tin khoa</Link></span>
                </section>

                <section className='section'>
                    <header className='section__header'>
                        <div className='section__header-left'>
                            <h3 className='section__title'>Xem thông tin khoa</h3>
                            <p className='section__subtitle'>Xem thông tin chi tiết của khoa</p>
                        </div>
                    </header>
                        ...
                        <div className='section-body-main'>
                            <form autoComplete='off'>
                                ...
                                <div className='form-group'>
                                    ...
                                    <input type='text' className='form-input-disabled' value={ getValue(this.state.data.tenKhoa) } disabled />
                                </div>
...
export default connect(mapStateToProps, null)(KhoaForView)